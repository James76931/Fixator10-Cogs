...
class Leveler(commands.Cog):
    ...
    async def draw_profile(self, user, server):
        ...
        draw.rectangle([(100, 203), (285, 285)], fill=info_color)  # info content
        ...
        draw.text((105, 207), "Info Box", font=sub_header_fnt, fill=white_color)  # Info Box
        margin = 105
        offset = 223
